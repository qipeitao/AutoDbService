...
namespace Microsoft.EntityFrameworkCore
{
        ...
        IDbContextPoolable
    {
        ...
        /// <returns>返回值</returns>
        public virtual T Map<T>(T t )
        {
            return Copy<T>(t);
        }
       
        private  T Copy<T>(T source, int level = 0)
        {
            if (source == null)
            {
                return default(T);
        ...
        private  T ObjectToClone<T>(T source, int level, int maxLevel) 
        {
            ...
            source.GetType().GetProperties()
                .ToList().ForEach(p =>
                {
                    ...
                    && p.GetCustomAttribute<NotMappedAttribute>() == null)
                    {
                        ...
                        if(_sets.Keys.Any(t=>t.Type==p.PropertyType)//dbset类
                        || v is IEnumerable vv)//列表类
                        {
        ...
        /// </summary>
        /// <typeparam name="TEntity"> The type of the entity. </typeparam>
        /// <param name="m"> The entity to add. </param>
        /// <returns>
        ///     The <see cref="EntityEntry{TEntity}" /> for the entity. The entry provides
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry<TEntity> Add<TEntity>([NotNull] TEntity m)
            where TEntity : class
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        /// </summary>
        /// <typeparam name="TEntity"> The type of the entity. </typeparam>
        /// <param name="m"> The entity to attach. </param>
        /// <returns>
        ///     The <see cref="EntityEntry{TEntity}" /> for the entity. The entry provides
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry<TEntity> Attach<TEntity>([NotNull] TEntity m)
            where TEntity : class
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        /// </summary>
        /// <typeparam name="TEntity"> The type of the entity. </typeparam>
        /// <param name="m"> The entity to update. </param>
        /// <returns>
        ///     The <see cref="EntityEntry{TEntity}" /> for the entity. The entry provides
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry<TEntity> Update<TEntity>([NotNull] TEntity m)
            where TEntity : class
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        /// </remarks>
        /// <typeparam name="TEntity"> The type of the entity. </typeparam>
        /// <param name="m"> The entity to remove. </param>
        /// <returns>
        ///     The <see cref="EntityEntry{TEntity}" /> for the entity. The entry provides
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry<TEntity> Remove<TEntity>([NotNull] TEntity m)
            where TEntity : class
        {
            var entity = Map(m);
            Check.NotNull(entity, nameof(entity));
        ...
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry Add([NotNull] object m)
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry Attach([NotNull] object m)
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry Update([NotNull] object m)
        {
            var entity = Map(m);
            CheckDisposed();
        ...
        ///     access to change tracking information and operations for the entity.
        /// </returns>
        public virtual EntityEntry Remove([NotNull] object m)
        {
            var entity = Map(m);
            Check.NotNull(entity, nameof(entity));
            CheckDisposed();
        ...
        ///     be inserted into the database when <see cref="SaveChanges()" /> is called.
        /// </summary>
        /// <param name="m"> The entities to add. </param>
        public virtual void AddRange([NotNull] params object[] m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        public virtual Task AddRangeAsync([NotNull] params object[] m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        ///     </para>
        /// </summary>
        /// <param name="m"> The entities to attach. </param>
        public virtual void AttachRange([NotNull] params object[] m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        ///     </para>
        /// </summary>
        /// <param name="m"> The entities to update. </param>
        public virtual void UpdateRange([NotNull] params object[] m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        ///     </para>
        /// </remarks>
        /// <param name="m"> The entities to remove. </param>
        public virtual void RemoveRange([NotNull] params object[] m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        /// </summary>
        /// <param name="m"> The entities to add. </param>
        public virtual void AddRange([NotNull] IEnumerable<object> m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        /// </summary>
        /// <param name="m"> The entities to attach. </param>
        public virtual void AttachRange([NotNull] IEnumerable<object> m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        /// </summary>
        /// <param name="m"> The entities to update. </param>
        public virtual void UpdateRange([NotNull] IEnumerable<object> m)
        {
            var entities = Map(m.ToList());
            CheckDisposed();
        ...
        /// </remarks>
        /// <param name="m"> The entities to remove. </param>
        public virtual void RemoveRange([NotNull] IEnumerable<object> m)
        {
            var entities = Map(m.ToList());
